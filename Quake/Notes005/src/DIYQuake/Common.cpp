...
void Common::Init(MemoryManager* pMemorymanager, System* pSystem, Parameters* pParameters)
{
...
byte_t* Common::LoadFile(char* szFileName, byte_t* pBuffer, int iBufferSize)
{
   return LoadFileToMemory(szFileName, LOAD_MEMORY::HUNK_TEMP_STACK, nullptr, iBufferSize, pBuffer);
}
...
byte_t* Common::LoadFileToMemory(char* szFileName, Common::LOAD_MEMORY eLoadMemory, Cache::CacheData* pData, int iBufferSize, byte_t* pBuffer)
{
