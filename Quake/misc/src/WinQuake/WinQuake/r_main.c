...
void R_RenderView_(void)
{
   ...
   // AngryCPPCoder Draw Walls/Map/World
   R_EdgeDrawing();
   ...
   // Below code would draw the player weapon
   R_DrawViewModel();
   ...
   // AngryCPPCoder: Draw Wepons particles from explosions 
   R_DrawParticles();
